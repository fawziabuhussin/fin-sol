...
>(({ className, ...props }, ref) => (
  <th
    ref={ref}
    className={cn("h-11 px-4 text-right align-middle font-medium text-slate-500", className)}
    {...props}
  />
));
...
>(({ className, ...props }, ref) => (
  <td ref={ref} className={cn("p-4 align-middle text-slate-900", className)} {...props} />
));
